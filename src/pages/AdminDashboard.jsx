  ...
  const handleSaleSave = async (e) => {
    ...
    try {
      ...
      const saleAmount = salesForm.sale_amount || 
        (salesForm.plot_value ? salesForm.plot_value - (salesForm.discount_amount || 0) : 0);
      ...
      const saleData = {
        ...
        client_id: salesForm.client_id ? parseInt(salesForm.client_id) : null
      };
...
function AdminDashboard() {
  ...
  // ============= TARGET SAVE FUNCTION WITH WEEKLY SUPPORT =============
  const handleTargetSave = async (e) => {
    e.preventDefault();
    try {
      // Parse the period from form (e.g., "march-2026")
